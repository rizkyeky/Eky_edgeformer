...
@register_dataset(name="krsbi", task="detection")
class KRSBIDetection(BaseImageDataset):
    """
        Dataset class for the COCO Object detection
    ...
    def __init__(self, opts, is_training: Optional[bool] = True, is_evaluation: Optional[bool] = False):
        ...
        split = 'train' if is_training else ('test' if is_evaluation else 'val')
...
@register_dataset(name="krsbi_ssd", task="detection")
class KRSBIDetectionSSD(KRSBIDetection):
    """
        Dataset class for the KRSBI Object detection using SSD
    """
    def __init__(self, opts, is_training: Optional[bool] = True, is_evaluation: Optional[bool] = False):
        super(KRSBIDetectionSSD, self).__init__(
            opts=opts,
            is_training=is_training,
            is_evaluation=is_evaluation
        )
