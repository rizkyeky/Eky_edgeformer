...
def arguments_common(parser: argparse.ArgumentParser) -> argparse.ArgumentParser:
    ...
    group.add_argument('--common.config-file', type=str,
                       default='parcnet/config/detection/edgeformer/ssd_edgeformer_s.yaml')
    group.add_argument('--common.results-loc', type=str, default="/Users/eky/Documents/_SKRIPSI/code/result/classificaion_imagenet1k", help="Directory where results will be stored")
